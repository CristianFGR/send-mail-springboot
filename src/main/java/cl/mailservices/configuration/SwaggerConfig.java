...
/**
 * Created by cgonroja on 07-08-19.
 */
@Configuration
@EnableSwagger2
public class SwaggerConfig {

    private static final String PACKAGE_CONTROLLER = "cl.mailservices.controller";
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo("Microservices Rest send-mail", "MicroServicio que implementa " +
                "envios de correos con spring boot y thymeleaf",
